        ...
        <Container maxWidth={'xl'} sx={{marginTop:theme.spacing(15)}}>
            ...
            <VerticalTimeline lineColor="var(--green4)">
                <VerticalTimelineElement
                    ...
                    contentStyle={{ border: '2px solid var(--green4)', color: '#000',boxShadow:'0 3px 12px #ddd' }}
                ...
                >
                    ...
                    <Typography fontWeight={500} color={theme.color.red}>
                ...
                <VerticalTimelineElement
                    className="vertical-timeline-element--work"
                    date="11/2005"
                    contentStyle={{ border: '2px solid var(--red)', color: '#000',boxShadow:'0 3px 12px #ddd' }}
                ...
                >
                    <Typography variant="h5" textAlign={"center"} fontWeight={700} color={theme.color.red}>29/11/2005</Typography>
                     <Typography fontWeight={500} color={theme.color.green1}>
                ...
                <VerticalTimelineElement
                    className="vertical-timeline-element--work"
                    date="02/1998"
                    contentStyle={{ border: '2px solid var(--green1)', color: '#000',boxShadow:'0 3px 12px #ddd' }}
